...
func (r *TimeTypeAddDay) GetType() string {
	return "time_type.add_day"
}

func (r *TimeTypeAddDay) New() rule_time.TimeConstItf {
	return new(TimeTypeAddDay)
}

func (r *TimeTypeAddDay) GetHash() string {
	for r.hash == nil {
...
func (r *TimeTypeAddDay) GetTime(facts facts.FactsItf) (time.Time, error) {
...
func (r *TimeTypeAddDay) UnmarshalJSON(data []byte) (err error) {
