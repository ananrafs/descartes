...
func (c *EqualWildcard) GetType() string {
	return "rules.string.equal.wildcard"
}

func NewEqualWildcard() rules.RulesItf {
	o := new(EqualWildcard)
	o.RuleType = o.GetType()
	return o
}

func (c *EqualWildcard) GetHash() string {
	for c.hash == nil {
...
func (c *EqualWildcard) IsMatch(facts facts.FactsItf) (isMatch bool, err error) {
	...
	// If value is "ALL" or "*", always match (wildcard)
